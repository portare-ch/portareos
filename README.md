...
2D system a choice of latency or visuals: latency adds one frame of
run-ahead and keeps the CRT filter, visuals is the picture as shipped. In RetroArch, M2 shows a game
